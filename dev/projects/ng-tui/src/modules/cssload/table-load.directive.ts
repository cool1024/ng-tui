...
export class TableLoadDirective implements AfterViewInit, OnDestroy {
  ...
  removeDom(): void {
    this.loadDom &&
      this.loadDom.parentElement &&
      this.loadDom.parentElement.removeChild(this.loadDom);
  }
  ...
  ngAfterViewInit(): void {
    ...
    this.parentDom.classList.add(TUI_CONST.BOOTSTRAP.CLASS.POSITION.RELATIVE);
