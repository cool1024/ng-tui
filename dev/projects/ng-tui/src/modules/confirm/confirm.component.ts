            ...
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button (click)="dismiss()" type="button" class="btn btn-white">
                            {{ config.cancelTitle }}
                        </button>
                        <button (click)="confirm()" type="button" class="btn btn-{{ color }}">
                            {{ config.okTitle }}
                        </button>
                    </div>
                </div>
...
export class ConfirmComponent {
    ...
    tryClose(eventDom: HTMLElement | any): void {
    ...
    updateHandle(): Observable<boolean> {
