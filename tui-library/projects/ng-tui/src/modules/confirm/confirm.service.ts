...
export class ConfirmService {
    ...
    create(title: string, message: string, options: ConfirmOptions): Observable<boolean> {
        this.init();
    ...
    info(title: string, message: string, options?: { okTitle?: string; cancelTitle?: string }): Observable<boolean> {
    ...
    warning(title: string, message: string, options?: { okTitle?: string; cancelTitle?: string }): Observable<boolean> {
        const config = this.combineOptions(options || {});
        config.icon = 'warning';
    ...
    danger(title: string, message: string, options?: { okTitle?: string; cancelTitle?: string }): Observable<boolean> {
        const config = this.combineOptions(options || {});
        config.icon = 'wrong';
        config.color = 'danger';
        return this.create(title, message, config);
    ...
    success(title: string, message: string, options?: { okTitle?: string; cancelTitle?: string }): Observable<boolean> {
        const config = this.combineOptions(options || {});
        config.icon = 'success';
