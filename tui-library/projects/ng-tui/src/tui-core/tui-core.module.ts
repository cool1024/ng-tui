...
@NgModule({
    ...
    exports: [ToggleDirective, TsHoverDirective, ViewDirective, RequestPipe, CommonModule],
    declarations: [ToggleDirective, TsHoverDirective, ViewDirective, RequestPipe],
    providers: [ValueChangeListenerService, ConfigService, ComponentService, ComponentHandleService],
})
