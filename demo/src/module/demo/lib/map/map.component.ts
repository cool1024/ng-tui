...
export class MapComponent implements AfterViewInit {
    ...
    getPointInfo(point: [number, number] = [116.396574, 39.992706]): void {
    ...
    getPosition(event: MapEvent): void {
    ...
    getPointDistance(lng1: number, lat1: number, lng2: number, lat2: number): void{
        this.mapService.geometryUtil((gutil, amap) => {
            this.consoleLog = {
                point1: { lng1, lat1 },
                point2: { lng2, lat2 },
